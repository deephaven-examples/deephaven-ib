...
tables_all = client.tables
table_names_all = tables_all.keys()

table_names_verified = [
    "requests",
    "accounts_managed",
    "accounts_family_codes",
    "accounts_aliases",
    "accounts_groups",
    "accounts_overview",
    "accounts_summary",
...
s2 = set(table_names_verified)
s3 = set(table_names_cant_verify)
s4 = s1.difference(s2).difference(s3)
table_names_unverified = list(s4)
table_names_unverified.sort()
tables_unverified = {k: v for k, v in tables_all.items() if k in table_names_unverified}

print("==============================================================================================================")
print("==== Verified.")
print("==============================================================================================================")

print(table_names_verified)

print("==============================================================================================================")
print("==== >>>>>>>> Cant verify. <<<<<<<<<< ")
print("==============================================================================================================")

print(table_names_cant_verify)

print("==============================================================================================================")
print("==== Unverified.")
print("==============================================================================================================")

print(table_names_unverified)
...
for k, v in tables_unverified.items():
    # print(f"Display: {k}")
    globals()[k] = v
